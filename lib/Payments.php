...
use PayU\Util\ApiServiceUtil as PayUApiServiceUtil;
...
class Payments {
	...
	{
		return Payments::doPayment($parameters,TransactionType::AUTHORIZATION_AND_CAPTURE, $lang);
	}
	...
	public static function doPayment($parameters, $transactionType, $lang){
		...
		if($paymentMethodParameter != null){
			...
			$responseAvailability = Payments::getPaymentMethodAvailability($paymentMethodParameter, $lang);
			...
			if (array_key_exists(PayUParameters::TOKEN_ID,$parameters)) {
				...
				$processWithoutCvv2 = Payments::isProcessWithoutCvv2Param($parameters);
	...
	public static function  doAuthorization($parameters, $lang = null){
		return Payments::doPayment($parameters, TransactionType::AUTHORIZATION, $lang);
	}
	...
	public static function doCapture($parameters, $lang = NULL){
		return Payments::processTransactionAlreadyAuthorizated($parameters, TransactionType::CAPTURE, $lang);
	}
	...
	public static function doVoid($parameters, $lang = NULL){
		return Payments::processTransactionAlreadyAuthorizated($parameters, TransactionType::VOID, $lang);
	}
	...
	public static function doRefund($parameters, $lang = NULL){
		return Payments::processTransactionAlreadyAuthorizated($parameters, TransactionType::REFUND, $lang);
	}
